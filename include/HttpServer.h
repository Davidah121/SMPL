...
namespace smpl
{
    ...
    public:
         ...
         * @param func 
         */
        void setGetFuncMapper(std::function<char(HttpServer*, WebRequest&, std::vector<unsigned char>&, std::string, size_t)> func);
         ...
         * @param func 
         */
        void setPostFuncMapper(std::function<char(HttpServer*, WebRequest&, std::vector<unsigned char>&, std::string, size_t)> func);
         ...
         * @param func 
         */
        void setExtraRequestHandlerFuncMapper(std::function<char(HttpServer*, WebRequest&, std::vector<unsigned char>&, std::string, size_t)> func);
         ...
         * @param func 
         */
        void setResponseHandlerFuncMapper(std::function<void(HttpServer*, WebRequest&, std::string, size_t, WebRequest&)> func);
         ...
         * @return int 
         */
        int sendResponse(WebRequest& response, std::string ip, size_t id, WebRequest& req);
    ...
    private:
        ...
        std::function<char(HttpServer*, WebRequest&, std::vector<unsigned char>&, std::string, size_t)> getFuncMapper;
        std::function<char(HttpServer*, WebRequest&, std::vector<unsigned char>&, std::string, size_t)> postFuncMapper;
        std::function<char(HttpServer*, WebRequest&, std::vector<unsigned char>&, std::string, size_t)> extraReqHandler;
        std::function<void(HttpServer*, WebRequest&, std::string, size_t, WebRequest&)> extraResponseHandler;
        ...
        char staggeredSend(size_t id, File f, size_t startPoint, size_t endPoint);
    };
}
