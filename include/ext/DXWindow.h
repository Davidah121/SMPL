...
namespace glib
{
	...
	public:
		 ...
		 */
		DXWindow(std::wstring title, int width = 320, int height = 240, int x = -1, int y = -1, unsigned char windowType = NORMAL_WINDOW);
		 ...
		 * 		Default value is 0 which is a Normal Focusable Thread Managed Window.
		 */
		DXWindow(std::string title, int width = 320, int height = 240, int x = -1, int y = -1, unsigned char windowType = NORMAL_WINDOW);
	...
	private:
		...
		size_t windowHandle; //Don't do this
