...
namespace glib
{
	...
	public:
		...
		static const int KEY_BACKSPACE = 0x08 | NEGATIVE;
		static const int KEY_TAB = 0x09 | NEGATIVE;
		static const int KEY_ENTER = 0x0D | NEGATIVE;
		static const int KEY_SHIFT = 0x10 | NEGATIVE;
		static const int KEY_CONTROL = 0x11 | NEGATIVE;
		static const int KEY_ALT = 0x12 | NEGATIVE;
		static const int KEY_PAUSE = 0x13 | NEGATIVE;
		static const int KEY_CAPSLOCK = 0x14 | NEGATIVE;
		static const int KEY_ESCAPE = 0x1B | NEGATIVE;
		static const int KEY_SPACE = 0x20 | NEGATIVE;
		...
		static const int KEY_RIGHT = 0x27 | NEGATIVE;
		static const int KEY_DOWN = 0x28 | NEGATIVE;
		static const int KEY_PRINTSCREEN = 0x2C | NEGATIVE;
		static const int KEY_INSERT = 0x2D | NEGATIVE;
		static const int KEY_DELETE = 0x2E | NEGATIVE;

		static const int KEY_NUMPAD0 = 0x60 | NEGATIVE;
		static const int KEY_NUMPAD1 = 0x61 | NEGATIVE;
		static const int KEY_NUMPAD2 = 0x62 | NEGATIVE;
		static const int KEY_NUMPAD3 = 0x63 | NEGATIVE;
		static const int KEY_NUMPAD4 = 0x64 | NEGATIVE;
		static const int KEY_NUMPAD5 = 0x65 | NEGATIVE;
		static const int KEY_NUMPAD6 = 0x66 | NEGATIVE;
		static const int KEY_NUMPAD7 = 0x67 | NEGATIVE;
		static const int KEY_NUMPAD8 = 0x68 | NEGATIVE;
		static const int KEY_NUMPAD9 = 0x69 | NEGATIVE;

		static const int KEY_NUMPAD_MULTIPLY = 0x6A | NEGATIVE;
		static const int KEY_NUMPAD_ADD = 0x6B | NEGATIVE;
		static const int KEY_NUMPAD_ENTER = 0x6C | NEGATIVE;
		static const int KEY_NUMPAD_SUBTRACT = 0x6D | NEGATIVE;
		static const int KEY_NUMPAD_DECIMAL = 0x6E | NEGATIVE;
		static const int KEY_NUMPAD_DIVIDE = 0x6F | NEGATIVE;

		static const int KEY_F1 = 0x70 | NEGATIVE;
		static const int KEY_F2 = 0x71 | NEGATIVE;
		static const int KEY_F3 = 0x72 | NEGATIVE;
		static const int KEY_F4 = 0x73 | NEGATIVE;
		static const int KEY_F5 = 0x74 | NEGATIVE;
		static const int KEY_F6 = 0x75 | NEGATIVE;
		static const int KEY_F7 = 0x76 | NEGATIVE;
		static const int KEY_F8 = 0x77 | NEGATIVE;
		static const int KEY_F9 = 0x78 | NEGATIVE;
		static const int KEY_F10 = 0x79 | NEGATIVE;
		static const int KEY_F11 = 0x7A | NEGATIVE;
		static const int KEY_F12 = 0x7B | NEGATIVE;
		static const int KEY_F13 = 0x7C | NEGATIVE;
		static const int KEY_F14 = 0x7D | NEGATIVE;
		static const int KEY_F15 = 0x7E | NEGATIVE;
		static const int KEY_F16 = 0x7F | NEGATIVE;
		static const int KEY_F17 = 0x80 | NEGATIVE;
		static const int KEY_F18 = 0x81 | NEGATIVE;
		static const int KEY_F19 = 0x82 | NEGATIVE;
		static const int KEY_F20 = 0x83 | NEGATIVE;
		static const int KEY_F21 = 0x84 | NEGATIVE;
		static const int KEY_F22 = 0x85 | NEGATIVE;
		static const int KEY_F23 = 0x86 | NEGATIVE;
		static const int KEY_F24 = 0x87 | NEGATIVE;

		static const int KEY_NUMLOCK = 0x90 | NEGATIVE;
		static const int KEY_SCROLL_LOCK = 0x91 | NEGATIVE;
		
		static const int KEY_LSHIFT = 0xA0 | NEGATIVE;
		static const int KEY_RSHIFT = 0xA1 | NEGATIVE;
		static const int KEY_LCONTROL = 0xA2 | NEGATIVE;
		static const int KEY_RCONTROL = 0xA3 | NEGATIVE;

		static const int KEY_PLUS = 0xBB | NEGATIVE;
		static const int KEY_COMMA = 0xBC | NEGATIVE;
		static const int KEY_MINUS = 0xBD | NEGATIVE;
		static const int KEY_PERIOD = 0xBE | NEGATIVE;

		static const int KEY_FORWARD_SLASH = 0xBF | NEGATIVE;
		static const int KEY_TILDE = 0xC0 | NEGATIVE;
		static const int KEY_SEMICOLON = 0xBA | NEGATIVE;
		static const int KEY_LEFT_SQUARE_BRACKET = 0xDB | NEGATIVE;
