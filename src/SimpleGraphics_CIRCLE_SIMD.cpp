		...
		if (otherImg != nullptr)
		{
			...
			if(!antiAliasing)
			{
				...
				for(int tY=minY; tY<maxY; tY++)
				{
					...
					fillBetween(activeColorAsSIMD, x1, x2, tY, surf);
				}
			...
			else
			{
				...
				for(int tY=minY; tY<maxY; tY++)
				{
					...
					fillBetween(activeColorAsSIMD, x3, x4, tY, surf);
				}
				RESET_LARGE_ENOUGH_CLAUSE()
			}
		}
			...
			if(!antiAliasing)
			{
				...
				for(int tY=minY; tY<maxY; tY++)
				{
					...
					if(xRangeOuterCircle.size() < 2 || xRangeInnerEdgeCircle.size() < 2)
					{
						...
						fillBetween(activeColorAsSIMD, xRangeOuterEdgeCircle[1], xRangeOuterEdgeCircle[0], tY, surf);
					}
					else
					{
						...
						//draw left side
						fillBetween(activeColorAsSIMD, xRangeOuterEdgeCircle[1], xRangeInnerEdgeCircle[1], tY, surf);
						
						if(xRangeInnerCircle.size() < 2)
						{
							fillBetween(activeColorAsSIMD, xRangeInnerEdgeCircle[1], xRangeInnerEdgeCircle[0], tY, surf);
						}
						else
						{
							fillBetween(activeColorAsSIMD, xRangeInnerEdgeCircle[1], xRangeInnerCircle[0], tY, surf);

							//draw right side
							fillBetween(activeColorAsSIMD, xRangeInnerCircle[0], xRangeInnerEdgeCircle[0], tY, surf);
						}

						//draw right side
						fillBetween(activeColorAsSIMD, xRangeInnerEdgeCircle[0], xRangeOuterEdgeCircle[0], tY, surf);
					}
			...
			else
			{
				...
				for(int tY=minY; tY<maxY; tY++)
				{
					...
					else if(xRangeInnerEdgeCircle.size() < 2)
					{
						...
						fillBetween(activeColorAsSIMD, xRangeOuterCircle[1], xRangeOuterCircle[0], tY, surf);
					}
					else
					{
						//fill between the outer and inner edge.
						...
						fillBetween(activeColorAsSIMD, xRangeOuterCircle[1], xRangeInnerEdgeCircle[1], tY, surf);
						...
						fillBetween(activeColorAsSIMD, xRangeInnerEdgeCircle[0], xRangeOuterCircle[0], tY, surf);
