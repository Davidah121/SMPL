...
#if (OPTI >= 1)
unsigned long long SIMD_128_8::getSIMDBound(unsigned long long s)
{
	return (s>>4)<<4;
}

SIMD_128_8::SIMD_128_8()
{

}
SIMD_128_8::SIMD_128_8(char byte)
{
    values = _mm_set1_epi8(byte);
}


SIMD_128_8::SIMD_128_8(__m128i sseValue)
{
    values = sseValue;
}

SIMD_128_8::SIMD_128_8(const SIMD_128_8& other)
{
    this->values = other.values;
}
void SIMD_128_8::operator=(const SIMD_128_8& other)
{
    this->values = other.values;
}

SIMD_128_8::SIMD_128_8(const SIMD_128_8&& other) noexcept
{
    this->values = other.values;
}
void SIMD_128_8::operator=(const SIMD_128_8&& other) noexcept
{
    this->values = other.values;
}
...
//load / store
SIMD_128_8 SIMD_128_8::load(char* pointer)
{
    SIMD_128_8 v;
    v.values = _mm_loadu_si128((__m128i*)pointer);
    return v;
}
void SIMD_128_8::store(char* pointer)
{
...
//bitwise
SIMD_128_8 SIMD_128_8::operator>>(const int shift) const
{
...
void SIMD_128_8::operator>>=(const int shift)
{
    __m128i low = _mm_cvtepi8_epi16(values);
    __m128i high = _mm_cvtepi8_epi16(_mm_srli_si128(values, 8));
...
SIMD_128_8 SIMD_128_8::operator&(const int v) const
{
...
void SIMD_128_8::operator&=(const int v)
{
...
SIMD_128_8 SIMD_128_8::bitwiseAndNot(const int v) const
{
    return _mm_andnot_si128(values, _mm_set1_epi8(v));
}
SIMD_128_8 SIMD_128_8::bitwiseAndNot(const SIMD_128_8& other) const
{
    return _mm_andnot_si128(values, other.values);
}

void SIMD_128_8::bitwiseAndNot(const int v)
{
    values = _mm_andnot_si128(values, _mm_set1_epi8(v));
}
void SIMD_128_8::bitwiseAndNot(const SIMD_128_8& other)
{
    values = _mm_andnot_si128(values, other.values);
}

//comparison
SIMD_128_8 SIMD_128_8::operator>(const char byte) const
{
    return _mm_cmpgt_epi8(values, _mm_set1_epi8(byte));
}
SIMD_128_8 SIMD_128_8::operator>(const SIMD_128_8& other) const
{
    return _mm_cmpgt_epi8(values, other.values);
}

SIMD_128_8 SIMD_128_8::operator<(const char byte) const
{
    return _mm_cmplt_epi8(values, _mm_set1_epi8(byte));
}
SIMD_128_8 SIMD_128_8::operator<(const SIMD_128_8& other) const
{
    return _mm_cmplt_epi8(values, other.values);
}

SIMD_128_8 SIMD_128_8::operator==(const char byte) const
{
    return _mm_cmpeq_epi8(values, _mm_set1_epi8(byte));
}
SIMD_128_8 SIMD_128_8::operator==(const SIMD_128_8& other) const
{
