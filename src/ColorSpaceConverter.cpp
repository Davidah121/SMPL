        ...
        switch(type)
        {
            ...
            case XYZ_TO_RGB:
                ...
                if(finalColor.x <= 0.0031308)
                    ...
                    finalColor.x = (1.055 * MathExt::pow((double)finalColor.x, 1.0/2.4)) - 0.055;

                if(finalColor.y <= 0.0031308)
                    finalColor.y *= 12.92;
                else
                    finalColor.y = (1.055 * MathExt::pow((double)finalColor.y, 1.0/2.4)) - 0.055;
                    
                if(finalColor.z <= 0.0031308)
                    finalColor.z *= 12.92;
                else
                    finalColor.z = (1.055 * MathExt::pow((double)finalColor.z, 1.0/2.4)) - 0.055;
