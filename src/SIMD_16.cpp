...
#if (OPTI >= 1)
unsigned long long SIMD_128_16::getSIMDBound(unsigned long long s)
{
	return (s>>3)<<3;
}

SIMD_128_16::SIMD_128_16()
{

}
SIMD_128_16::SIMD_128_16(short byte)
{
    values = _mm_set1_epi16(byte);
}

SIMD_128_16::SIMD_128_16(__m128i sseValue)
{
    values = sseValue;
}

SIMD_128_16::SIMD_128_16(const SIMD_128_16& other)
{
    this->values = other.values;
}
void SIMD_128_16::operator=(const SIMD_128_16& other)
{
    this->values = other.values;
}

SIMD_128_16::SIMD_128_16(const SIMD_128_16&& other) noexcept
{
    this->values = other.values;
}
void SIMD_128_16::operator=(const SIMD_128_16&& other) noexcept
{
    this->values = other.values;
}
...
//load / store
SIMD_128_16 SIMD_128_16::load(short* pointer)
{
    SIMD_128_16 v;
    v.values = _mm_loadu_si128((__m128i*)pointer);
    return v;
}
void SIMD_128_16::store(short* pointer)
{
...
//bitwise
SIMD_128_16 SIMD_128_16::operator>>(const int shift) const
{
...
void SIMD_128_16::operator>>=(const int shift)
{
...
SIMD_128_16 SIMD_128_16::operator&(const int v) const
{
...
void SIMD_128_16::operator&=(const int v)
{
...
SIMD_128_16 SIMD_128_16::bitwiseAndNot(const int v) const
{
    return _mm_andnot_si128(values, _mm_set1_epi16(v));
}
SIMD_128_16 SIMD_128_16::bitwiseAndNot(const SIMD_128_16& other) const
{
    return _mm_andnot_si128(values, other.values);
}

void SIMD_128_16::bitwiseAndNot(const int v)
{
    values = _mm_andnot_si128(values, _mm_set1_epi16(v));
}
void SIMD_128_16::bitwiseAndNot(const SIMD_128_16& other)
{
    values = _mm_andnot_si128(values, other.values);
}

//comparison
SIMD_128_16 SIMD_128_16::operator>(const short byte) const
{
    return _mm_cmpgt_epi16(values, _mm_set1_epi16(byte));
}
SIMD_128_16 SIMD_128_16::operator>(const SIMD_128_16& other) const
{
    return _mm_cmpgt_epi16(values, other.values);
}

SIMD_128_16 SIMD_128_16::operator<(const short byte) const
{
    return _mm_cmplt_epi16(values, _mm_set1_epi16(byte));
}
SIMD_128_16 SIMD_128_16::operator<(const SIMD_128_16& other) const
{
    return _mm_cmplt_epi16(values, other.values);
}
...
SIMD_128_16 SIMD_128_16::horizontalAdd(const SIMD_128_16& other) const
{
    return _mm_hadd_epi16(values, other.values);
}

int SIMD_128_16::sum() const
{
