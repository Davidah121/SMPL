...
set debugOptions=-g -fsanitize=address
...
set sslLibs=-L "C:\Program Files\OpenSSL-Win64\lib\VC\x64\MD" -l libssl -l libcrypto -l crypt32
...
set linkOptions=%windowsSDKLibs% %sslLibs% %networkLibs% %windowLibs% %audioLibs% %xinputLibs% %dinputLibs% %performanceLibs% %semlLibs% %serializationLibs%
set extraOptions=-O3 -fopenmp
set projectCommand=./bin/Release/obj/*.o -o ./bin/Release/test.exe
